                            ...
                            <div class="dropdown-menu drop-3">
                                <div class="profile d-flex mr-o">
                                    <div class="profile-l align-self-center">
                                        <a> <img src="images/profile.jpg" class="img-fluid mb-3" alt="Responsive image"></a>
                                    </div>
                                    <div class="profile-r align-self-center">
                                        <h3 class="sub-title-w3-agileits"><?= $_SESSION['username']; ?></h3>
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?php echo $_SERVER['PHP_SELF'].'?lg=true'; ?>">Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
